...
<div class="wrapper col0">
  <div id="topbar">
    ...
    <div id="loginpanel">
      <ul>
        <li  class="left"><a style="padding-left:-30px" href="logout.php"> Logout &raquo;</a></li><b><?php echo strtoupper($guru) ?></b>
          </ul>
    </div>
    <br class="clear" />
  </div>
  ...
  <div class="fl_left">
      ...
      <ul class="nav nav-stacked">
        ...
        <li><a href="?p=profil_guru">Profil</a></li>
         <li><a href="?p=nilai">Nilai</a></li>
        <li><a href="?p=laporan_siswa">Laporan Siswa</a></li>
        <li><a href="?p=laporan_nilai">Laporan Nilai</a></li>
    ...
    <div class="fl_right">
      ...
      if(isset($_GET['p'])){
        switch ($_GET['p']) {
          case 'dasboard_wali':
              $page = 'dasboard_wali.php';
            break;

          case 'profil_guru':
              $page = 'profil_guru/index.php';
            break;
          case 'tambahprofil_guru':
              $page = 'profil_guru/tambah.php';
            break;
          case 'editprofil_guru':
              $page = 'profil_guru/edit.php';
            break;
           case 'nilai':
              $page = 'nilai/index.php';
            break;
          case 'tambahnilai':
              $page = 'nilai/tambah.php';
            break;
          case 'editnilai':
              $page = 'nilai/edit.php';
            break;
          case 'hapusnilai':
              $page = 'nilai/hapus.php';
            break;
           case 'tambahList':
              $page = 'nilai/tambahList.php';
            break;
          case 'tambahData':
              $page = 'nilai/tambahData.php';
            break; 
          case 'laporan_nilai':
              $page = 'laporan_nilai/index.php';
            break;
          case 'cari_laporannilai':
              $page = 'laporan_nilai/cari_laporannilai.php';
            break;
          case 'laporan_siswa':
              $page = 'laporan_siswa/index.php';
            break;
          case 'cari_laporansiswa':
              $page = 'laporan_siswa/cari_laporansiswa.php';
            break;
         /* case 'siswa':
